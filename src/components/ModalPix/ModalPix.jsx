...
export default function ModalPix({
        ...
        async function buscarQrCode() {
            try {
                ...
                const res = await fetch(
                    `http://localhost:5000/reservas/gerar_qrcode/${idReserva}`
                );
    ...
    return (
        <>
            <div
                className={estilo.fundoOpaco}
                onClick={!confirmando ? aoFechar : undefined}
            ></div>
            <div className={estilo.modalContainer}>
                <div className={`${estilo.modal} rounded-4`}>
                    <h1 className={estilo.textoModal}>
                        Pagamento via PIX
                    </h1>
                    <div className={estilo.pixContent}>
                        ...
                        {payload && (
                            <div className={estilo.pixInfo}>
                                <span className={estilo.pixLabel}>
                                    Copia e Cola
                                </span>
